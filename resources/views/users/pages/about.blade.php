...
@section('title', 'About | Invest Smart')
...
@section('main-content')
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="about-image">
                        <img src="{{ url('user-assets') }}/img/about/ab.jpg" alt="">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="about-content">
                        <h3>A Investment firm is a business of one or more experts that provides professional investment
                            service</h3>
    ...
    <div class="feature-area bg-color fix area-padding">
        <div class="container">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="feature-content">
                        <div class="feature-images">
                            <img src="{{ url('user-assets') }}/img/feature/f1.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="feature-text">
                        ...
                        <p>Replacing a maintains the amount of lines. When replacing a selection. help agencies to
                            define their new business objectives and then create. Replacing a maintains the amount of
                            lines. When replacing a selection. help agencies to define their new business objectives and
                            then create. Replacing a maintains the amount of lines. When replacing a selection. help
            ...
            <div class="row margin-row" style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="overview-images">
                        <img src="https://img.freepik.com/premium-photo/stock-market-forex-trading-graph-candlestick-chart-suitable-financial-investment-concept_54178-3092.jpg" alt="">
                    </div>
                </div>
                <!-- End Column -->
