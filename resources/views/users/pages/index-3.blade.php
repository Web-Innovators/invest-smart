...
<!-- Mirrored from rockstheme.com/rocks/Invest Smart-live/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Mar 2020 08:27:43 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Home-2 | Invest Smart</title>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="topbar-left">
                            <ul>
                                <li><a href="#"><i class="fa fa-envelope"></i> info@Invest Smart4.com</a></li>
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="logo">
                                    ...
                                    <a class="navbar-brand page-scroll black-logo" href="index.html">
                                        <img src="img/logo/ft-logo.png" alt="">
                                    </a>
                                </div>
                                <!-- logo end -->
                            </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-example">
                                        <div class="main-menu">
                                            <ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a href="investment.html">Packages</a></li>
                                                ...
                                                <li><a class="pages" href="gallery.html">Gallery</a>
                                                    <!-- <ul class="sub-menu">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mobile-menu">
                            <div class="logo">
                                <a href="index.html"><img src="img/logo/ft-logo.png" alt="" /></a>
                            </div>
                            <nav id="dropdown">
                                <ul>
                                    <li><a class="pages" href="index.html">Home</a>
        ...
        <div class="intro-carousel">
            <div class="intro-content">
                <div class="slider-images">
                    <img src="img/slider/bg-img.jpg" alt="">
                </div>
                        ...
                        <div class="faq-quote">
                            <div class="row">
                                <form id="contactForm" method="POST"
                                    action="http://rockstheme.com/rocks/Invest Smart-live/contact.php" class="contact-form">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="footer-content logo-footer">
                            <div class="footer-head">
                                <div class="footer-logo">
                                    <a class="footer-black-logo" href="#"><img src="img/logo/ft-logo.png" alt=""></a>
                                </div>
                                <p>
...
<!-- Mirrored from rockstheme.com/rocks/Invest Smart-live/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Mar 2020 08:27:46 GMT -->
